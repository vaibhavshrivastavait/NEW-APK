...
export default function SymptomsScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* FIXED: Removed KeyboardAvoidingView that was causing button movement */}
      <View style={styles.mainContent}>
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {/* FIXED: Added padding bottom to prevent content cutoff */}
          <View style={styles.scrollPadding} />
        </ScrollView>

        {/* FIXED: Button container with absolute positioning for stability */}
...
const styles = StyleSheet.create({
  ...
  // FIXED: New main content container
  mainContent: {
    flex: 1,
    position: 'relative',
  },
  ...
  // FIXED: Padding for scroll area
  scrollPadding: {
    height: 80,
  },
  // FIXED: Absolutely positioned button container for stability
