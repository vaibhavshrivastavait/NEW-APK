...
export default function HomeScreenFixed({ navigation }: Props) {
  // REMOVED: Drug interaction checker to prevent reduce error
  ...
  const handleDrugInteractionChecker = () => {
    console.log('Drug Interaction Checker - Feature available in mobile app');
    // Placeholder for drug interaction checker
    alert('Drug Interaction Checker will be available in the mobile app!');
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.featuresGrid}>
          <TouchableOpacity 
            ...
            onPress={handleDrugInteractionChecker}
          >
            <MaterialIcons name="medication" size={28} color="#E91E63" />
            <View style={styles.featureContent}>
              <Text style={styles.featureTitle}>Drug Interaction Checker</Text>
              <Text style={styles.featureSubtitle}>150+ HRT drug interactions analysis</Text>
            </View>
          </TouchableOpacity>
